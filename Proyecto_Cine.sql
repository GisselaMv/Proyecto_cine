...
CREATE TABLE IF NOT EXISTS `proyecto_cine`.`pelicula_has_actor` (
  ...
  INDEX `fk_pelicula_has_actor_pelicula1_idx` (`pelicula_id_pelicula` ASC, `pelicula_ticket_id_ticket` ASC) ,
...
CREATE TABLE IF NOT EXISTS `proyecto_cine`.`distribuidora_has_pelicula` (
  ...
  INDEX `fk_distribuidora_has_pelicula_pelicula1_idx` (`pelicula_id_pelicula` ASC, `pelicula_ticket_id_ticket` ASC) ,
